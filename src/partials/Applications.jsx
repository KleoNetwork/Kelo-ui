          ...
          <div className="max-w-sm mx-auto md:max-w-none">
            ...
            <article className="flex flex-col h-full bg-gray-300 px-5 pt-5 pb-5" data-aos="zoom-y-out">
                ...
                <footer className="text-sm flex items-center mt-4">
                  ...
                  <ul>
                  <li className="m-1">
                        <a className="inline-flex text-center text-gray-100 py-1 px-3 rounded-full bg-blue-500 hover:bg-blue-600 transition duration-150 ease-in-out" href="#0">+11 Brownie Points</a>
                  </li>
                  </ul>
                  </div>
              ...
              <article className="flex flex-col h-full bg-gray-300 px-5 pt-5 pb-5" data-aos="zoom-y-out">
                ...
                <footer className="text-sm flex items-center mt-4">
                  ...
                  <ul>
                  <li className="m-1">
                        <a className="inline-flex text-center text-gray-100 py-1 px-3 rounded-full bg-blue-500 hover:bg-blue-600 transition duration-150 ease-in-out" href="#0">+3 Brownie Points</a>
                  </li>
                  </ul>
                  </div>
              ...
              <article className="flex flex-col h-full bg-gray-300 px-5 pt-5 pb-5" data-aos="zoom-y-out">
                ...
                <footer className="text-sm flex items-center mt-4">
                  ...
                  <ul>
                  <li className="m-1">
                        <a className="inline-flex text-center text-gray-100 py-1 px-3 rounded-full bg-blue-500 hover:bg-blue-600 transition duration-150 ease-in-out" href="#0">+12 Brownie Points</a>
                  </li>
                  </ul>
                  </div>
              ...
              <article className="flex flex-col h-full bg-gray-300 px-5 pt-5 pb-5" data-aos="zoom-y-out">
                ...
                <footer className="text-sm flex items-center mt-4">
                  ...
                  <ul>
                  <li className="m-1">
                        <a className="inline-flex text-center text-gray-100 py-1 px-3 rounded-full bg-blue-500 hover:bg-blue-600 transition duration-150 ease-in-out" href="#0">+7 Brownie Points</a>
                  </li>
                  </ul>
                  </div>
              ...
              <article className="flex flex-col h-full bg-gray-300 px-5 pt-5 pb-5" data-aos="zoom-y-out">
                ...
                <footer className="text-sm flex items-center mt-4">
                  ...
                  <ul>
                  <li className="m-1">
                        <a className="inline-flex text-center text-gray-100 py-1 px-3 rounded-full bg-blue-500 hover:bg-blue-600 transition duration-150 ease-in-out" href="#0">+13 Brownie Points</a>
                  </li>
                  </ul>
                  </div>
